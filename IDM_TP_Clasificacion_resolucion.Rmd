...
```{r f-setup-show, echo=TRUE, message=FALSE, warning=FALSE}
...
acc_full_train <- confusionMatrix(pred_full_train, train$diabetes, positive = "pos")$overall["Accuracy"]
acc_full_test  <- confusionMatrix(pred_full_test,  test$diabetes,  positive = "pos")$overall["Accuracy"]
...
knitr::kable(comp, booktabs = TRUE, digits = 4, linesep = "",
  ...
  kableExtra::kable_styling(latex_options = "HOLD_position", position = "center", font_size = 9)
```
